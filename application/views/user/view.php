	  			...
	  			<div class="row">
	  				...
	  				<div class="col-md-12">
	  					...
	  					<div class="invoice p-3 mb-3">
	  						...
	  						<?php if ($rapat['status_rapat'] == 1 or $rapat['status_rapat'] == 2) : ?>
	  							<button type="button" class="btn btn-primary btn-sm mb-2 mt-2" data-toggle="modal" data-target="#add-user">
	  								Tambah Peserta
	  							</button>
	  						<?php else : ?>
	  						<?php endif; ?>
	  						<a href="<?php echo base_url('user/view_gambar/' . $rapat['id_rapat']); ?>" class="btn btn-primary btn-sm mb-2 mt-2"><i class="fas fa-upload"></i> Unggah Foto</a>
	  						<div class="row">
	  										...
	  										<?php foreach ($list_peserta as $lu) : ?>
	  											<tr>
	  												...
	  												<?php if ($lu['status_rapat'] == 1) : ?>
	  													<td><a href="<?php echo base_url('user/batal/' . $lu['id_peserta']); ?>" class="tombol-batal btn btn-info btn-block btn-sm"><i class="far fa-times-circle"></i> Batal</a></td>
	  												<?php else : ?>
	  						...
	  						<div class="row no-print">
	  							<?php if ($rapat['status_rapat'] == 0) : ?>
	  								<div class="col-12">
	  									<a href="<?php echo base_url('user/cetak/' . $rapat['id_rapat']); ?>" target="_blank" class="btn btn-default"><i class="fas fa-print"></i> Cetak Peserta</a>
	  									<a href="<?php echo base_url('user/cetak_notulen/' . $rapat['id_rapat']); ?>" target="_blank" class="btn btn-default"><i class="fas fa-print"></i> Cetak Notulen</a>
	  								</div>
	  							<?php else : ?>
	  							<?php endif; ?>
	  						</div>
	  	...
	  	<div class="modal-dialog">
	  		<div class="modal-content">
	  			...
	  			<div class="modal-body">
	  				<div class="box-body">
	  					<form action="<?php echo base_url('user/view/' . $rapat['id_rapat']); ?>" method="post" id="form_id">
	  ...
	  <div class="modal fade" id="edit-user">
	  	<div class="modal-dialog">
	  		<div class="modal-content">
	  			...
	  			<div class="modal-body">
	  				<div class="box-body">
	  					<form action="<?php echo base_url('user/edit_rapat'); ?>" method="post" id="form_id">
	  						<div class="form-group">
